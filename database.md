...
![两次写](https://github.com/zhgit-hub/notes/blob/master/image/DoubleWrite.png)     
...
##  InnoDB逻辑存储结构
![逻辑存储结构](https://github.com/zhgit-hub/notes/blob/master/image/StorageStructure.png)  
表空间-段-区-页-行
...
##  InnoDB的内存管理
### 缓冲池   
![缓冲池](https://github.com/zhgit-hub/notes/blob/master/image/BufferPool.png)   
